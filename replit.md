...
- CYBERSMART HOSTING LIMITATIONS IDENTIFIED (August 11, 2025): Cybersmart responded confirming Node.js 18-20 and SSL support, but CANNOT provide PostgreSQL database or PM2 process management on shared hosting. This creates fundamental incompatibility with our PostgreSQL + Drizzle ORM architecture. Alternative hosting solutions required: Hetzner SA, AWS Cape Town, or application modification to MySQL. Decision needed on hosting provider change vs. architecture modification.
