    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mb-6">
          Latest coupons generated by buyers. Personal information is protected for privacy.
        </p>
      </div>
            ...
            <Card key={coupon.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  {/* Coupon Code (partially masked) */}
                  <div className="bg-gray-50 p-2 rounded border">
                    <div className="text-xs text-gray-500 uppercase tracking-wide mb-1">
                      Coupon Code
                    </div>
                    <div className="font-mono text-sm">
                      {coupon.couponCode.slice(0, 8)}***{coupon.couponCode.slice(-4)}
                    </div>
                  </div>
